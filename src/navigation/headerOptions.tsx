 ...
 * The title itself slides in from the left while fading in, replayed on every focus.
 */
export const themedHeaderOptions: NativeStackNavigationOptions = {
  headerShadowVisible: false,
  animation: 'none',
  headerTitle: (props) => <AnimatedHeaderTitle title={props.children} tintColor={props.tintColor} />,
};
